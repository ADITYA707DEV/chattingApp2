...
const io = require("socket.io")(http, {
  ...
  cors: ["http://localhost:3000","https://chattingapp2.onrender.com","http://localhost:5000"],
})
...
app.use(cors({
  ...
  origin: ["http://localhost:3000","https://chattingapp2.onrender.com","http://localhost:5000"]
}))
